...
namespace UnitTests.Impls
{
    ...
    public class PitClientTests
    {
        ...
        public async Task GetAllPitsSession_ClientReturnsFailure_ReturnsFailureMessage()
        {
            ...
            clientMock.Setup(c => c.Get(It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(singleResponse);
            ...
            clientMock.Verify(c => c.Get("pit?", "session_key=1"), Times.Once);
        }
        ...
        public async Task GetAllPitsSession_ItemNull_ReturnsSessionContainsNoPitsMessage()
        {
            ...
            clientMock.Verify(c => c.Get("pit?", "session_key=2"), Times.Once);
        ...
        public async Task GetAllPitsSession_ValidJson_ReturnsMappedPits()
        {
            ...
            clientMock.Verify(c => c.Get("pit?", "session_key=4"), Times.Once);
        }
        ...
        public async Task GetAllPitsSession_GetThrowsException_ReturnsFailureWithException()
        {
            ...
            clientMock.Setup(c => c.Get(It.IsAny<string>(), It.IsAny<string>())).ThrowsAsync(new InvalidOperationException("boom"));
            ...
            clientMock.Verify(c => c.Get("pit?", "session_key=5"), Times.Once);
        }
    }
}
