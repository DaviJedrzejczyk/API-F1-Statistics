...
namespace Dao.Migrations
{
    ...
    [Migration("20260919172914_alter_column_f1_lap_fast_sectors_observation_can_null")]
    partial class alter_column_f1_lap_fast_sectors_observation_can_null
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Class.CarData", b =>
                {
            ...
            modelBuilder.Entity("Entities.Class.Driver", b =>
                {
            ...
            modelBuilder.Entity("Entities.Class.Lap", b =>
                {
                    b.Property<int>("MeetingKey")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Class.LapFastSector", b =>
                {
                    b.Property<int>("SessionKey")
                        .HasColumnType("int");
                    ...
                    b.HasKey("SessionKey", "DriverNumber", "Sector");

                    b.ToTable("F1_LAPS_FAST_SECTORS", (string)null);
                });
            ...
            modelBuilder.Entity("Entities.Class.Meeting", b =>
                {
                    b.Property<int>("MeetingKey")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Class.Overtake", b =>
                {
                    b.Property<int>("MeetingKey")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Class.Pit", b =>
                {
                    b.Property<DateTime>("Date")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Entities.Class.RaceControl", b =>
                {
                    b.Property<DateTime>("Date")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Entities.Class.Session", b =>
                {
                    b.Property<int>("SessionKey")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Class.SessionResult", b =>
                {
                    b.Property<int>("SessionKey")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Class.Stint", b =>
                {
                    b.Property<int>("MeetingKey")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Class.LapSegment", b =>
                {
                    b.HasOne("Entities.Class.Lap", "Lap")
                        .WithMany("Segments")
